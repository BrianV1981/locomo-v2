...
PROJECT_ROOT = "/home/kingb/aim-memeval"
DATA_FILE = "/home/kingb/locomo-v2/benchmark_toolkit/longmemeval_scripts/data/longmemeval_s_cleaned.json"
...
def get_latest_transcript():
    ...
    search_dir = os.path.expanduser("~/.gemini/tmp/aim-memeval/chats/*.jsonl")
...
def run_ghost_operator():
    ...
    out_dir = "/home/kingb/benchmark_results/reports/longmemeval"
    os.makedirs(out_dir, exist_ok=True)
    out_file = os.path.join(out_dir, f"longmemeval_predictions_{timestamp}.json")
    ...
    primer_msg = "MANDATE: You are about to be given a series of LongMemEval questions. This is a strict benchmark testing your RAG v5.2 memory system. Before we begin, you MUST use your tools to read the AGENTS.md file in your root directory. Follow your AGENTS.md instructions precisely. Do not guess. Answer directly and concisely. Once you have read AGENTS.md and are ready, reply with '[ANSWER] YES'."
